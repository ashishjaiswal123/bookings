...
import (
	...
	"github.com/ashishjaiswal123/bookings/internal/driver"
	"github.com/ashishjaiswal123/bookings/internal/forms"
	"github.com/ashishjaiswal123/bookings/internal/helpers"
	...
	"github.com/ashishjaiswal123/bookings/internal/repository/dbrepo"
...
// NewHandlers sets the repository for the hndlers
...
// PostReservation handles the posting of a reservationb form
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	// another way for sending mail
	// htmlMessage, err := email.SendRoomConfirmationEmail(reservation)
	// if err != nil {
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.ErrorLog.Println("can't get err from session")
...
// PostShowLogin handles user loggin
